		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<br>
					...
					<h3>Add a product to table</h3>
					<br>
					
	                <div class="tab-content" id="tab2">
					 
						<form action="databaseinsertproducts.php" method="post" enctype="multipart/form-data">
							...
							<div>
								Add your product here, Close this notification with the 
								top-right cross.
							</div>
						</div>
								...
								<p>
									<label>ID</label>
										...
										<input class="text-input small-input" type="text" id="small-input" name="pid" /> 
								...
								<p>
									<label>Category</label>
										...
										<input class="text-input small-input" type="text" id="small-input" name="pcategory" /> 
								...
								<p>
									<label>Product Description</label>
										...
										<input class="text-input small-input" type="text" id="medium-input" name="pdescription" /> 
