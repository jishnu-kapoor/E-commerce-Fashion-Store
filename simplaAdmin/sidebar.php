...
<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<!-- Logo (221px wide) -->
			<a href="index.php"><img id="logo" src="resources/images/logo1.png" alt="Simpla Admin logo" /></a>
			...
			<div id="profile-links">
				...
				<br />
				<a href="../fashimain/fashi/index.php" title="View the Site">View the Site</a> | <a href="logout.php" title="Sign Out">Sign Out</a>
			</div>        
