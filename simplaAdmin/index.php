...
} //redirect to login if index page is directly called

// elseif($_SESSION['authorized']


// {
//     $_SESSION['token']= 'true';
	
// } // if session is authorised to load sidebar
...
<title>Shop 'n Save | Administrator</title>
